...
- Be concise. Whenever you type anything, ask yourself, 'is this necessary? Is this *really* necessary?' If not, delete the redundant text.
- This is an *academic* guide. Do not include irrelevant topics such as 'Finding supermarkets in Cambridge'.
- Don't over-modularize. Question your impulse to modularize contents. A guide is often more readable if things are in the same document. See the various guides on the [teaching website](https://teaching.eng.cam.ac.uk/) for bad examples.
